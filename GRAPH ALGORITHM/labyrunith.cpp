...
int getfib(int n)
{
    ...
    int x = (ARR[1] * II[1][1] + ARR[2] * II[2][1]) % 1000000007;
    return x;
}
int log(int x)
{
...
void init(int maxN, int phi[1000001])
{
    for (int i = 1; i <= maxN; i++)
        phi[i] = i;
    for (int i = 2; i <= maxN; i++)
...
main()
{
        ...
        for (int delrow = -1; delrow <= 1; delrow++)
        {
            for (int delcol = -1; delcol <= 1; delcol++)
            {
                if (abs(delrow - delcol) == 1)
                {
                    int nrow = r + delrow;
                    int ncol = c + delcol;
                    if (nrow >= 0 && ncol >= 0 && nrow < n && ncol < m && !vis[nrow][ncol] && mat[nrow][ncol] != '#')
                    {
                        vis[nrow][ncol] = 1;
                        mp[{nrow, ncol}] = {r, c};
                        if (nrow == fin.first && ncol == fin.second)
                        {
                            cout << "YES" << nl;
                            flag = false;
                        }
    ...
    {
        ans++;
        // if(fin.first==mp[fin].first && fin.second==(mp[fin].second+1)){
        // cout<<'R';
        // }else if(fin.first==mp[fin].first && fin.second==(mp[fin].second-1)){
        // cout<<'L';
        // }else if(fin.first==(mp[fin].first-1) && fin.second==(mp[fin].second)){
        // cout<<'U';
        // }else{
        // cout<<'D';
        // }
        // cout<<fin.first<<" "<<fin.second<<nl;
        fin = mp[fin];
    }
    string a = "";
    fin = st;
    ...
    cout << ans << nl;
    cout << a << nl;
    // if(fin.first==in.first && fin.second==(in.second+1)){
    // cout<<'U';
    // }else if(fin.first==in.first && fin.second==(in.second-1)){
    // cout<<'L';
    // }else if(fin.first==(in.first-1) && fin.second==(in.second)){
    // cout<<'R';
    // }else{
    // cout<<'L';
    // }
